// ===========================================================================
// Anthropic price map for the usage/cost ledger. Prices are USD per 1M tokens.
//
// ponytail: hardcoded from Anthropic's pricing page — there's no runtime source
// of truth for prices. Verify + update these when Anthropic changes pricing or
